...
public class JsonData implements Parcelable
{
    ...
    public final static Creator<JsonData> CREATOR = new Creator<JsonData>() {
        ...
        public JsonData createFromParcel(Parcel in) {
            ...
            in.readList(instance.popular, (com.example.finalproject.Modelnya.Popular.class.getClassLoader()));
            in.readList(instance.data, (com.example.finalproject.Modelnya.Datum.class.getClassLoader()));
